...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			div2 = element("div");
    			attr_dev(div0, "class", "box svelte-3qms16");
    			add_location(div0, file$3, 5, 0, 54);
    			attr_dev(div1, "class", "box svelte-3qms16");
    			add_location(div1, file$3, 8, 0, 112);
    			attr_dev(div2, "class", "box svelte-3qms16");
    			add_location(div2, file$3, 11, 0, 170);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					action_destroyer(drag_action = drag.call(null, div0, { direction: "x" })),
    					action_destroyer(drag_action_1 = drag.call(null, div1, { direction: "y" })),
    					action_destroyer(drag_action_2 = drag.call(null, div2))
    				];
    ...
    function create_if_block_2(ctx) {
    	...
    	nav = new Nav({
    			props: { toggleNav: /*toggleNav*/ ctx[4] },
    			$$inline: true
    		});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 51, 2, 1001);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 59, 2, 1129);
    			add_location(button, file$4, 60, 2, 1159);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	let if_block1 = /*isReady*/ ctx[3] && create_if_block_1(ctx);
    	toast = new Toast({ $$inline: true });
    	let if_block2 = /*isModalOpen*/ ctx[2] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$4, 44, 1, 836);
    			add_location(button1, file$4, 45, 1, 880);
    			add_location(button2, file$4, 46, 1, 927);
    			attr_dev(main, "class", "svelte-16o23iu");
    			add_location(main, file$4, 43, 0, 828);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*toggleNav*/ ctx[4], false, false, false),
    					listen_dev(button1, "click", /*toggleAlert*/ ctx[6], false, false, false),
    					listen_dev(button2, "click", /*toggleModal*/ ctx[5], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (/*isReady*/ ctx[3]) if_block1.p(ctx, dirty);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	return [name, isNavOpen, isModalOpen, isReady, toggleNav, toggleModal, toggleAlert];
    }
