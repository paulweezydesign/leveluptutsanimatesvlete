...
var app = (function () {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ scale, fly, toggleModal });
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = action_destroyer(drag_action = drag.call(null, div));
    				mounted = true;
    			}
    		},
    		p: noop,
