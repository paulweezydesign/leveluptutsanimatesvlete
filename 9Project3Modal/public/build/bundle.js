    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 48, 2, 959);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 56, 2, 1087);
    			add_location(button, file$3, 57, 2, 1117);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$3, 43, 1, 804);
    			add_location(button1, file$3, 44, 1, 848);
    			add_location(button2, file$3, 45, 1, 895);
    			attr_dev(main, "class", "svelte-16o23iu");
    			add_location(main, file$3, 42, 0, 796);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
