...
var app = (function () {
    ...
    function create_if_block_2(ctx) {
    	...
    	nav = new Nav({
    			props: { toggleNav: /*toggleNav*/ ctx[5] },
    			$$inline: true
    		});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 74, 2, 1400);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 108, 2, 1961);
    			add_location(button, file$4, 109, 2, 1991);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(108:1) <Modal {toggleModal}>",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	let if_block1 = /*isReady*/ ctx[4] && create_if_block_1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$4, 67, 1, 1235);
    			add_location(button1, file$4, 68, 1, 1279);
    			add_location(button2, file$4, 69, 1, 1326);
    			add_location(h30, file$4, 78, 2, 1488);
    			add_location(p0, file$4, 79, 2, 1504);
    			attr_dev(div0, "class", "card svelte-l63qpz");
    			add_location(div0, file$4, 77, 1, 1467);
    			add_location(h31, file$4, 83, 2, 1597);
    			add_location(p1, file$4, 84, 2, 1620);
    			attr_dev(div1, "class", "card svelte-l63qpz");
    			toggle_class(div1, "hidden", !/*isCardActive*/ ctx[3]);
    			add_location(div1, file$4, 82, 1, 1546);
    			add_location(h32, file$4, 88, 2, 1683);
    			add_location(p2, file$4, 89, 2, 1699);
    			attr_dev(div2, "class", "card svelte-l63qpz");
    			add_location(div2, file$4, 87, 1, 1662);
    			add_location(h33, file$4, 93, 2, 1762);
    			add_location(p3, file$4, 94, 2, 1778);
    			attr_dev(div3, "class", "card svelte-l63qpz");
    			add_location(div3, file$4, 92, 1, 1741);
    			add_location(h34, file$4, 98, 2, 1841);
    			add_location(p4, file$4, 99, 2, 1857);
    			attr_dev(div4, "class", "card svelte-l63qpz");
    			add_location(div4, file$4, 97, 1, 1820);
    			attr_dev(main, "class", "svelte-l63qpz");
    			add_location(main, file$4, 66, 0, 1227);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*toggleNav*/ ctx[5], false, false, false),
    					listen_dev(button1, "click", /*toggleAlert*/ ctx[7], false, false, false),
    					listen_dev(button2, "click", /*toggleModal*/ ctx[6], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (/*isReady*/ ctx[4]) if_block1.p(ctx, dirty);
